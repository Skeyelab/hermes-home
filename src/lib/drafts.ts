...
function buildAssetDataUrl(params: {
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" fill="none">
      ...
      <text x="64" y="184" fill="#ffffff" font-family="Inter, system-ui, sans-serif" font-size="${width >= 1100 ? 72 : 84}" font-weight="700" letter-spacing="-1.5">
        ${titleText}
      </text>
      <text x="64" y="${width >= 1100 ? 340 : 390}" fill="rgba(231,241,255,0.84)" font-family="Inter, system-ui, sans-serif" font-size="${width >= 1100 ? 30 : 34}" font-weight="400">
        ${summaryText}
      </text>
